...
export function LegalPopup({ type, open, onOpenChange }: LegalPopupProps) {
  const title = type === 'terms' ? 'Terms & Conditions' : 'Legal Notice';
  const content = type === 'terms' ? termsContent : legalContent;
